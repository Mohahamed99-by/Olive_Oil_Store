...
const WhatsAppButton = () => {
  const phoneNumber = '+212600000000'; // Replace with your actual WhatsApp number
  const message = 'مرحبا! أريد الاستفسار عن منتجاتكم'; // Default message
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <span className="absolute right-full mr-3 bg-black text-white text-sm py-2 px-4 rounded opacity-0 
